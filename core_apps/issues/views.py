...
class IsStaffSuperUser(permissions.BasePermission):
    # usamos o __init__() para ja iniciar a classe rodando esse código
...
class AssignedIssuesListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        # o uso do self.request.user é para obter o usuario logado
...
class IssueCreateAPIView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer: IssueSerializer) -> None:
        ...
        try:
            # tenant é para ter a segurança que somente se estiver logado e o usuario da requisição terá acesso aos dados
...
class IssueDetailAPIView(generics.RetrieveAPIView):
    ...
    def record_issue_view(self, issue):
        ...
        # aqui criamos uma instancia ou fazemos um update da instancia atual
