...
class ProfileListAPIView(generics.ListAPIView):
    ...
    # aqui incluimos o renderer la de commons, que tem o uso de object_label para indicar o titulo e os dados
    renderer_classes = [GenericJSONRenderer]
    pagination_class = StandardResultsSetPagination
    object_label = 'profile'
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    # aqui usamos o __ (double underscore) para indicar a ligação de user com profile
...
class ProfileUpdateAPIView(generics.RetrieveUpdateAPIView):
    ...
    def get_object(self) -> Profile:
        # o uso do request.user é devido a capturar o usuario já autenticado
...
class NonTenantProfileListAPIView(generics.ListAPIView):
    ...
    object_label = 'non_tenant_profile'
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    search_fields = ['user__username', 'user__first_name', 'user__last_name']
    filterset_fields = ['occupation', 'gender', 'country_of_origin']
